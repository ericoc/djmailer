    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_address', models.EmailField(db_column='from_address', default='djadmin@gaw.sh', help_text='Sender ("From") e-mail address of the message.', max_length=254, validators=[django.core.validators.EmailValidator()], verbose_name='From E-mail Address')),
                ('reply_to_address', models.EmailField(db_column='reply_to_address', default='djadmin@gaw.sh', help_text='"Reply-To" e-mail address of the message.', max_length=254, validators=[django.core.validators.EmailValidator()], verbose_name='Reply-To E-mail Address')),
                ('to_address', models.EmailField(db_column='to_address', help_text='Primary ("To") recipient e-mail address of the message.', max_length=254, validators=[django.core.validators.EmailValidator()], verbose_name='Recipient E-mail Address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_address', models.EmailField(db_column='from_address', default='djadmin@gaw.sh', help_text='From address of e-mail message(s) sent using the template.', max_length=254, validators=[django.core.validators.EmailValidator()], verbose_name='Sender E-mail Address')),
                ('reply_to_address', models.EmailField(db_column='reply_to_address', default='djadmin@gaw.sh', help_text='Reply-to address of e-mail message(s) sent using the template.', max_length=254, validators=[django.core.validators.EmailValidator()], verbose_name='Reply-to E-mail Address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(db_column='message', help_text='E-mail message related to the recipient.', on_delete=django.db.models.deletion.CASCADE, to='mailer.mailermessage', verbose_name='Message')),
            ],
            options={
